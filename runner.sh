#!/bin/bash
javac -cp contest.jar player38.java ParentSelection.java Recombination.java SurvivorSelection.java Mutation.java Individual.java
jar cmf MainClass.txt submission.jar player38.class ParentSelection.class Recombination.class SurvivorSelection.class Mutation.class Individual.class
